...
@snap[center]
  ...
  @size[0.5em](ハードリンク数<br/>)
  @size[0.5em](オーナユーザID,オーナグループID<br/>)
  @size[0.5em](ファイルサイズ（バイト数）<br/>)
  @size[0.5em](ファイルシステムI/Oのブロックサイズ<br/>)
  @size[0.5em](使用しているブロック数<br/>)
  @size[0.5em](最終アクセス時刻,最終更新時刻,最終情報変更時刻<br/>)
@snapend
---
...
@snap[center]
  @size[0.5em](ファイルアクセスにはinode番号を介して,ファイル情報を取得します.)
  @size[0.5em](inode番号は,ファイルのメタデータを内包しています.)
  @size[0.5em](ファイルのinode番号は`ls -i`で調べることができます.)
  @size[0.5em](inode番号は一意なものです.inode番号はファイルに一意に作成されますが,固定されたものではありません.)
  @size[0.5em](ファイルは最終アクセスしたファイルほど通常,番号は大きくなります.)
@snapend
