...
@snap[center]
  ...
  @size[0.5em](オーナユーザID<br/>)
  @size[0.5em](オーナグループID<br/>)
  @size[0.5em](ファイルサイズ（バイト数）<br/>)
  @size[0.5em](ファイルシステムI/Oのブロックサイズ<br/>)
  @size[0.5em](使用しているブロック数<br/>)
  @size[0.5em](最終アクセス時刻<br/>)
  @size[0.5em](最終更新時刻<br/>)
  @size[0.5em](最終情報変更時刻<br/>)
@snapend
---
...
O_APPEND<br/>
@size[0.8em](ファイルを追加書きモード)

O_ASYNC<br/>
@size[0.8em](ファイルが端末またはソケット時にシグナルを発生させます.)

O_CREAT<br/>
@size[0.8em](指定されたファイルがないときに,新たに作成します.)

O_DIRECT<br/>
@size[0.8em](ダイレクトI/O用にファイルを開く.)
